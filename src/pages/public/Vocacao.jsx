...
const faqs = [
  ...
  { q: 'Quantos anos dura a formação?', a: 'A formação no Seminário Maior dura 7 anos, divididos em dois ciclos: Filosofia (3 anos) e Teologia (4 anos), culminando com a ordenação diaconal e presbiteral.' },
  { q: 'Posso visitar o Seminário antes de me candidatar?', a: 'Sim! Organizamos fins-de-semana vocacionais e dias abertos. Entre em contacto connosco para agendar uma visita e conhecer a nossa comunidade.' },
  { q: 'Como se faz a candidatura?', a: 'A candidatura é feita através do formulário em papel disponível na diocese ou diretamente no Seminário, entre Junho e Agosto de cada ano. Inclui entrevistas, exames médicos e avaliação psicológica.' },
];
      ...
      <section className="bg-dark-900 text-white py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 leading-relaxed">
            Se sentes um chamamento interior para servir a Deus como sacerdote, esta página é para ti. Descobre mais sobre a vocação sacerdotal e como discernir.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={t.nome} className="card text-center">
